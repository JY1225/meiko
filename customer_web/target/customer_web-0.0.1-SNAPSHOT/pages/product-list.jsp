                                ...
                                <c:forEach items="${productPageInfo.list}" var="ofile" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="font-size:14px">
                                           ...
                                           <button type="button" class="btn bg-olive btn-xs" onclick="javascript:window.open('${pageContext.request.contextPath}/file/read?upload_filename=${ofile.upload_filename}')" >预览</button><span>${ofile.previews}</span>
                                            <button id="download_btn" type="button" class="btn bg-olive btn-xs"  onclick="location.href='${pageContext.request.contextPath}/file/download?upload_filename=${ofile.upload_filename}&recid=${ofile.recid}&down_loads=${ofile.down_loads}'" >下载</button><span>${ofile.down_loads}</span>

        ...
        <section class="content">    <!-- .box-body -->
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/orders/findAll?page=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
                            ...
                            <li><a href="${pageContext.request.contextPath}/orders/findAll?page=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
                        </ul>
                    </div>
                </div>       <!-- /.box-footer-->
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#changePageSize").change(function () {
            ...
            //向服务器发送请求，改变没页显示条数
            location.href = "${pageContext.request.contextPath}/orders/findAll?page=${pageInfo.pageNum}&pageSize=" + pageSize;
